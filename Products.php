            ...
            <div class="filter-container">
                ...
                <div class="search-options">
                    ...
                    <ul id="chosen-filter">
                        ...
                        while ($row = $connect->fetch(PDO::FETCH_ASSOC)) {
                        ?>
                            <li><label><input type="checkbox" class="chkbox subcategory" <?php if(isset($_GET['category'])) if (strtolower($row['subcategory_name']) == $_GET['category']) echo 'checked'; ?> value="<?php echo $row['subcategory_name'] ?>">&nbsp;<?php echo $row['subcategory_name'] ?></label></li>
