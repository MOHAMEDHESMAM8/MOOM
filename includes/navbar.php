...
<div class="nav-container">
  <ul class="popup-menu">
    <li>
        <a href="wishList.php" style="margin-right:20px;"><i class="fa fa-heart"></i>
          <span class="first_heart">
                <?php
        ...
        <a href="<?php echo 'profile.php?id=' . $_SESSION['ID'] ?>"><i class="fa fa-user"></i></a> 
    </li>
...
<nav>
  ...
  <div class="top">
    ...
    <a href="products.php"><img src="uploads/Images/logo.png" alt="Logo|M&#8734M "></a>
    ...
    <ul class="nav-icons">
      ...
      <li class="icon-none"><a href="wishList.php"><i class="fa fa-heart"></i>
      <span class="first_heart">
            <?php
              $count =$db->prepare("SELECT * FROM wishlist WHERE user_id=?" );
              $count->execute([$_SESSION['ID']]);
