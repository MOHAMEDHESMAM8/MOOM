...
$fetchUserInfo = $user_info->fetch();
                                    if (isset($_POST['add'])) {
                                        ...
                                        $inserting = $db->prepare('INSERT INTO products(product_name,
                                                                                    ...
                                                                                    VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)');
                                        $inserting->execute(array($pname, $mainCategory, $subCate, $pprice, $pDescription, $pplang, $pimg1_filename, $pimg2_filename, $pimg3_filename, $pimg4_filename, $pvid_filename, $user_id['user_id']));
                                    }
                                    ?>
            ...
            <div class="right-side">
                ...
                <div class="profile-body">
                    <div class="profile-post tab ">
                        <h1><?php echo $fetchUserInfo['first_name'] . ' ' . $fetchUserInfo['last_name'] ?> Products</h1>
                ...
                <div class="profile-reviews tab ">
                    <h1><?php echo $fetchUserInfo['first_name'] . ' ' . $fetchUserInfo['last_name'] ?> Reviews</h1>
                    <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Modi architecto obcaecati harum mollitia natus explicabo Lorem, ipsum dolor sit amet consectetur adipisicing elit. Earum, cupiditate distinctio iste asperiores nam suscipit! </p>
                        ...
                        <div class="container-settins">
                            <div class="name">
                                <div class="firstname">
                                    ...
                                    <?php
                                    $getNameData = $db->prepare('SELECT first_name, last_name,email,phone_no,bio FROM users WHERE username = ? limit 1');
                            ...
                            <div class="name2">
                                ...
                                <input type="file" name="profile_img" id="real-file"  />
                            </div>
                           
                            <div class="name2">
                                <label>upload Cover your photo</label>
                                <input type="file" name="cover_img" id="real-file" />
                            ...
                            <label>Bio </label>
                            <input type="textarea" placeholder="Your Bio " name="bio" value="<?php echo $data_name['bio'] ?>">
